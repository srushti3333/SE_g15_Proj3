...
const Wishlist: React.FC = () => {
  ...
  const restaurantCount =
    wishlist?.items?.filter((i: WishlistItem) => i.type === "restaurant")
      .length || 0;
  const menuItemCount =
    wishlist?.items?.filter((i: WishlistItem) => i.type === "menuItem")
      .length || 0;
      ...
      >
        <div>
          ...
          <p style={{ margin: "10px 0 0 0", color: "#666" }}>
            Your saved favorites and must-try items
          </p>
        </div>
        {totalItems > 0 && (
          <button
              ...
              >
                <span
                  style={{
                    ...
                    borderRadius: "6px",
                    background:
                      item.type === "restaurant" ? "#e3f2fd" : "#fff3e0",
                    fontSize: "13px",
                    fontWeight: "600",
                  }}
                >
